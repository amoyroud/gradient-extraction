 ...
 * It uses CSS animations for entrance and raw CSS gradients for the dynamic background.
 *
...
const AnimatedGradientBackground: React.FC<AnimatedGradientBackgroundProps> = ({
   ...
   const entranceStyle: React.CSSProperties = {
      ...
      transform: isVisible ? 'scale(1)' : 'scale(1.5)',
      transition: 'opacity 2s ease, transform 2s cubic-bezier(0.25, 0.1, 0.25, 1)',
   };
